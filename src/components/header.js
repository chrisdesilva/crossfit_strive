      ...
      <header id="navbar" className={isMenuOpen ? "navbar__opacity" : "navbar"}>
        <div id="navbar-closed">
          <div
            ...
            className={isMenuOpen ? "animate" : null}
          >
      ...
      <header className={navBackground ? "showNav" : null} id="navbar--md">
        ...
        <div id="navbar--md-open">
          <div id="navbar--md__links">
            <span className="link" onClick={() => toSection(".schedule")}>
              Schedule
            </span>
            <span className="link" onClick={() => toSection(".pricing")}>
              Pricing
            </span>
            <span className="link" onClick={() => toSection(".classes")}>
              Classes
            </span>
            <span className="link" onClick={() => toSection(".coaches")}>
              Coaches
            </span>
            <span className="link" onClick={() => toSection(".reviews")}>
              Reviews
            </span>
