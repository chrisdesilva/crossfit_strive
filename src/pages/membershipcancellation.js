...
const MembershipCancellation = () => {
  ...
  return (
    <div className="joinUs">
      ...
      >
        <input type="hidden" name="form-name" value="strive-cancel" />
        {!thankYou && (
          <React.Fragment>
            ...
            <label htmlFor="rating">
              Overall, how would you rate your Strive experience?
            </label>
            ...
            <label htmlFor="recommend">
              How likely are you to recommend Strive to other athletes?
            </label>
